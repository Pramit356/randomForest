...
print("but as we oberved the number of survivors and deaths is nearly same in most cases and we observe that the bulk of the")
print(" values is concentrated on the value for sibsp = 0, so we cannot justify it for classifying")
...
print("but that survival rate was only slightly less than the overall population survival rate")
...
print("According to the fraction estimates, people in port C have greater chance of survival")
